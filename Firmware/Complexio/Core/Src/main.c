...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_Pin|bin2_Pin|bin1_Pin|ain2_Pin
  ...
  /*Configure GPIO pins : LED_Pin bin2_Pin bin1_Pin ain2_Pin
                           ain1_Pin */
  GPIO_InitStruct.Pin = LED_Pin|bin2_Pin|bin1_Pin|ain2_Pin
                          |ain1_Pin;
